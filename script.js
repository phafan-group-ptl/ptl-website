document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        th: {
            ...
            nav_foreigner: "งานคนต่างด้าว",
            nav_about: "เกี่ยวกับ",
            nav_contact: "ติดต่อเรา",
            b_reg_partnership: "ห้างหุ้นส่วนจำกัด/บริษัทจำกัด",
            b_reg_foreign: "นิติบุคคลต่างด้าว",
            b_reg_boi: "BOI",
            ...
            service_foreigner_desc: "รับทำวีซ่า, ใบต่างด้าว, เปลี่ยนสัญชาติ, ใบอนุญาตทำงาน สำหรับชาวต่างชาติและแรงงาน",
            ...
            optgroup_foreigner: "งานคนต่างด้าว"
        },
        en: {
